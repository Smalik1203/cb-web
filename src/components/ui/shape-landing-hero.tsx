...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-100/30 via-transparent to-indigo-100/30 blur-3xl" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-50/20 via-transparent to-blue-50/20 pointer-events-none" />
        </div>
    );
}
